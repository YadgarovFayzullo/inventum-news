                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 lg:gap-8 items-center">
                    ...
                    <div className="lg:col-span-8">
                        ...
                        <motion.h1 
                            ...
                            className="text-6xl sm:text-8xl md:text-[10rem] font-black tracking-tighter leading-[0.8] text-foreground mb-12"
                        >
                            Будущее <br />
                            <span className="text-[var(--conura-sea)] italic decoration-[var(--conura-orange)]/20 underline decoration-8 underline-offset-[-10px]">науки</span> в <br />
                            вашем ритме.
                        </motion.h1>
                        ...
                        <motion.p 
                            ...
                            className="text-xl md:text-3xl text-muted-foreground font-semibold max-w-2xl mb-16 leading-tight border-l-4 border-[var(--conura-sea)] pl-10"
                        >
                        ...
                        >
                            <Button size="lg" className="h-24 px-16 rounded-[2rem] bg-foreground text-background hover:bg-foreground/90 font-black text-2xl transition-all hover:scale-105 active:scale-95 shadow-2xl shadow-foreground/10 group">
                                Читать свежее
                    ...
                    <div className="lg:col-span-4 flex justify-center lg:justify-end">
                        ...
                        >
                            ...
                            <motion.div 
                                ...
                                className="absolute -top-10 -right-10 h-32 w-32 rounded-full bg-card shadow-2xl border border-border flex flex-col items-center justify-center text-center p-4 z-20"
                            >
                                <span className="text-[var(--conura-sea)] font-black text-2xl leading-none">8.2к</span>
                                <span className="text-[8px] font-black uppercase tracking-widest mt-1 opacity-40 leading-none">Citations</span>
                            </motion.div>

                            <motion.div 
                                animate={{ y: [0, 20, 0] }}
                                transition={{ duration: 4, repeat: Infinity, ease: "easeInOut", delay: 1 }}
                                className="absolute -bottom-10 -left-10 h-40 w-40 rounded-full bg-foreground text-background shadow-2xl flex flex-col items-center justify-center text-center p-4 z-20"
                            >
                                <Globe size={32} weight="duotone" className="mb-2 text-[var(--conura-orange)]" />
                                <span className="text-xl font-black leading-none">Global</span>
                                <span className="text-[8px] font-black uppercase tracking-widest mt-1 opacity-40 leading-none">Reach</span>
                            </motion.div>
