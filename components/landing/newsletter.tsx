...
export function Newsletter() {
    return (
        <section className="py-16 sm:py-28 bg-foreground text-background relative overflow-hidden">
            ...
            <div className="mx-auto max-w-7xl px-6 sm:px-8 lg:px-12 relative z-10">
                <div className="grid lg:grid-cols-2 gap-12 sm:gap-20 items-center">
                    ...
                    <div>
                        ...
                        <h2 className="text-4xl sm:text-5xl md:text-7xl font-black tracking-tight leading-[0.9] mb-8 sm:mb-10">
                            Знания <br />
                    ...
                    <div className="bg-background/5 p-6 sm:p-12 md:p-16 rounded-[2.5rem] sm:rounded-[4rem] border border-background/10 backdrop-blur-sm">
                        <form className="space-y-6" onSubmit={(e) => e.preventDefault()}>
                            <div className="relative group">
                                ...
                                <Input 
                                    ...
                                    className="h-16 sm:h-20 pl-16 pr-8 bg-background/5 border-2 border-background/10 rounded-3xl text-lg sm:text-xl font-bold placeholder:text-background/20 focus-visible:ring-[var(--conura-sea)] focus-visible:border-[var(--conura-sea)] transition-all"
                                />
                            </div>
                            <Button className="h-16 w-full sm:h-20 rounded-3xl bg-background text-foreground hover:bg-background/90 text-lg sm:text-xl font-black gap-4 transition-all hover:scale-[1.02] active:scale-95 group">
                                Подписаться на дайджест
                                <ArrowRight size={24} weight="bold" className="group-hover:translate-x-2 transition-transform" />
                            </Button>
                        </form>
                        <p className="mt-8 text-center text-sm font-semibold opacity-40 leading-relaxed px-4">
